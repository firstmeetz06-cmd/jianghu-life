/**
 * 江湖人生 - SVG 图标集 (Lucide 风格 24x24 细线)
 * 所有图标使用 stroke 渲染，currentColor 继承颜色
 */
...
export const icons = {
  // 属性图标
  martial:    svg('<path d="M14.5 17.5L3 6V3h3l11.5 11.5"/><path d="M13 19l6-6"/><path d="M16 16l4 4"/><path d="M19 21l2-2"/>'),
  knowledge:  svg('<path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/>'),
  charm:      svg('<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>'),
  reputation: svg('<circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/>'),
  wealth:     svg('<line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>'),
  ...
  morality:   svg('<circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/>'),
  ...
  sword:      svg('<polyline points="14.5 17.5 3 6V3h3l11.5 11.5"/><line x1="13" y1="19" x2="19" y2="13"/><line x1="16" y1="16" x2="20" y2="20"/>'),
  hourglass:  svg('<path d="M5 22h14"/><path d="M5 2h14"/><path d="M17 22v-4.172a2 2 0 0 0-.586-1.414L12 12l-4.414 4.414A2 2 0 0 0 7 17.828V22"/><path d="M7 2v4.172a2 2 0 0 0 .586 1.414L12 12l4.414-4.414A2 2 0 0 0 17 6.172V2"/>'),
...
/**
 * 在 Vue 模板中使用：v-html="icon('martial')"
 */
export function icon(name, size) {
  return icons[name] ? (size ? icons[name].replace(/width="\d+"/, `width="${size}"`).replace(/height="\d+"/, `height="${size}"`) : icons[name]) : ''
}
